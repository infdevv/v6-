...
function createBookmark(title, url) {
    var index = localStorageData.push({name: title, url: url, favicon: `https://t0.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=${url}&size=553`});
    addBookmark(title, url, `https://t0.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=${url}&size=553`, index);
    save();
    sendMessage({
