...
document.addEventListener("DOMContentLoaded",function(){
    current_mode = localStorage.getItem("aboutbrowser_mode_override")
    document.getElementById(current_mode).click()

    if (localStorage.getItem("aboutbrowser_start_image")){
        document.body.style.backgroundImage = "url(" + localStorage.getItem("aboutbrowser_start_image") + ")";
